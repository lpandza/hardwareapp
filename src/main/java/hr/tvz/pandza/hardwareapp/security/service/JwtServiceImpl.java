...
import hr.tvz.pandza.hardwareapp.security.domain.Authority;
import hr.tvz.pandza.hardwareapp.security.domain.User;
import hr.tvz.pandza.hardwareapp.security.user.ApplicationUser;
import hr.tvz.pandza.hardwareapp.security.user.UserAuthentication;
